								...
								<div class="form-group">
									...
									<div class="col-md-8">
										<div class="col-md-6 text-center">
											<img class="img-thumbnail" src="{{ $asset('vendor/fluxbb/installer/public/img/RD_demo.png') }}" alt="" width="128" height="" />
											<input type="radio" id="default_style" name="default_style" value="FluxBB2" checked />
										</div>
										<div class="col-md-6 text-center">
											<img class="img-thumbnail" src="{{ $asset('vendor/fluxbb/installer/public/img/Air_demo.png') }}" alt="" width="128" height="" />
