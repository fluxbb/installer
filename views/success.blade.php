...
@section('main')
		...
		<div id="brdinstall" class="installer">
			...
			<div id="instx" class="box">
				...
				<p>Everything went smooth, your brand new FluxBB 2 Forum is up and running! A notification email has been sent to you to confirm that. You can now <a href="{{ route('admin') }}">go to the Dashboard</a> and start customizing your Forum, or <a href="{{ route('admin') }}">take the tour</a> and discover all the new features from FluxBB 2.</p>
				<div class="btn-group">
